...
//    var_dump($contacts);
    ...
    echo "<tr><th>Address:</th><td><input type='string' name='address' maxlength='95' required pattern='K[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{94}' size='95' value=''></td></tr>";
...
//  var_dump($contact);
    ...
    echo "<tr><th>Address:</th><td><input type='string' maxlength='97' maxlength='95' required pattern='K[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{94}' size='95' name='address' value='".$contact["address"]."'></td></tr>";
    ...
    if ($maxAmount > 0) {
      echo "<h3>Send KRB to contact</h3>";
