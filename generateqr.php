...
if (validate_address($address)) {
  ...
  echo "<tr><th>Wallet address:</th><td><input type='string' name='address' maxlength='95' required pattern='K[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{94}' size='95' value=''></td></tr>";
