<?php
  ...
  echo number_format($availableBalance / 100, 2), " KRB<br>";
  echo "<b>Locked balance:</b><br>";
  echo number_format($lockedBalance / 100, 2), " KRB<br>";
  echo "</p><br>";
  ...
  $dt = date("Y");
  echo "<p class='footer'>&copy; ", $dt != "2018" ? "2018&ndash;" : "", date("Y"), " Karbo Project</p>";
  echo "</div>";
?>
