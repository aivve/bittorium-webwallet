...
//    var_dump($contacts);
    ...
    echo "<tr><th>Address:</th><td><input type='string' name='address' maxlength='95' required pattern='K[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{94}' value=''></td></tr>";
...
//  var_dump($contact);
    ...
    echo "<tr><th>Address:</th><td><input type='string' maxlength='95' required pattern='K[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{94}' name='address' size='95' value='".$contact["address"]."'></td></tr>";
