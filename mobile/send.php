...
if (logged_in()) {
  ...
  if (!isset($_POST['recipient']) || !isset($_POST['amount'])) {
    ...
    echo "<tr><th>Recipient address:</th><td><input type='text' maxlength='95' required pattern='K[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{94}' name='recipient'></td>";
